...
class CrudUserController extends Controller
{
    ...
    public function authUser(Request $request)
    {
        ...
        return redirect("login")->withSuccess('Login details are not valid');//neu doi login thanh list se nhap gi cung co the vo list dc
    ...
    public function postUser(Request $request)
    {
        ...
        return redirect("login");//neu doi login thanh list se nhap gi cung co the vo list dc
    }
